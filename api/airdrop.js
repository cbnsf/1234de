...
const TOKEN_MINT_ADDRESS = process.env.TOKEN_MINT_ADDRESS || 'YOUR_TOKEN_MINT_ADDRESS';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 添加转账指令 (25,000个代币，假设代币有6位小数)
    const transferAmount = 25000 * Math.pow(10, 9); // 调整为你的代币小数位数
